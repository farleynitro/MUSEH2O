...
from problem_formulation_gini import CombinedTraditionalGiniMean, CombinedTraditionalGiniStd, CombinedTraditionalGiniRatioStdMean
...
def main():
    ...
    gini_std = CombinedTraditionalGiniStd(n_decision_vars, n_objectives_justice,
                                          n_years, rbf)

    gini_mean = CombinedTraditionalGiniMean(n_decision_vars, n_objectives_justice,
                                            n_years, rbf)

    gini_ratio_std_mean = CombinedTraditionalGiniRatioStdMean(n_decision_vars, n_objectives_justice,
                                                              n_years, rbf)
    ...
    problem_choices = [gini_mean, gini_std, gini_ratio_std_mean]
    # choose problem
